...
class SorveteForm extends React.Component {
    ...
    handleSubmit(event) {
        ...
        alert('Seu sabor escolhido foi: ' + sabor 
        + ', guardanapos ' + guardanapos
        + ', casquinha: ' + casquinha);
        event.preventDefault(); // Apenas para não fazer o redirect do form.
    }
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} style={{ display: 'flex' }}>
                ...
                <label>
                    <input type="checkbox" name="casquinha" 
                ...
                <label>
                    ...
                    <div className="radio">
                        <label>
                            <input type="radio" id="guardanapos"
                             name="guardanapos"
                             value="sim" 
